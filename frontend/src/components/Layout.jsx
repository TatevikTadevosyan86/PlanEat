...
/**
 * Shared application chrome with header navigation and footer.
 *
 * @param {{
      ...
      <div className="flex min-h-screen flex-col">
        <header className="h-24 border-b border-[#dbe7de] bg-white">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
            ...
            {/* Navigation stays shared here so auth state is reflected consistently on every page. */}
            <nav className="hidden items-center text-lg font-medium text-[#7c9488] md:flex">
              <div className="flex items-center gap-8">
                <Link to="/" className="hover:text-[#1f5c4d]">
                  Home
                </Link>
                <Link to="/inventory" className="hover:text-[#1f5c4d]">
                  Inventory
                </Link>
                <Link to="/meal-plan" className="hover:text-[#1f5c4d]">
                  Meal Plan
                </Link>
                <Link to="/shopping-list" className="hover:text-[#1f5c4d]">
                  Shopping List
                </Link>
            ...
            <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
              ...
              <div className="md:text-right">
                ...
                <ul className="mt-3 space-y-2 text-sm text-[#8ba095]">
                  <li>
                    <a href="#" className="transition hover:text-[#1f5c4d]">
                      FAQ
                    </a>
                  </li>
