import { Beef, Carrot, Egg, Fish, Milk, Utensils, Wheat } from 'lucide-react'

// Maps common inventory keywords to a simple icon and color used across the UI.
...
/**
 * Finds a presentational icon configuration for a free-text ingredient name.
 *
 * @param {string} ingredientName
 * @returns {{ icon: import('lucide-react').LucideIcon, color: string, label: string }}
 */
...
/**
 * Displays a small ingredient icon badge.
 *
